...
int main()
{
	...
	cout << "Compoter Doublons :" << sport.compterDoublons(*produits[0]) << endl;
	...
	cout << *(martine.obtenirPanier()->trouverProduitPlusCher()) << "  Est le plus cher" << endl;
